...
public class Demo {
	...
	public void testInsert() throws SolrServerException, IOException{
		SolrClient client = new HttpSolrClient("http://192.168.0.68:8080/solr/");
		
		SolrInputDocument doc = new SolrInputDocument();
		doc.addField("id", "001");
		doc.addField("title", "001java和大数据培训");
...
//		params.setQuery("bjsxtall:*");
		...
		for (SolrDocument doc : solrList) {
			...
			System.out.println("未高亮:"+doc.getFieldValue("title"));
